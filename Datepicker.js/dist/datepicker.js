!function (e, t) {
  ...
  function o(e, t) {
    e.classList.add.apply(e.classList, t.split(' ')
      .filter(Boolean));
  }

  function l(e, t) {
    e.classList.remove.apply(e.classList, t.split(' ')
      .filter(Boolean));
  }
    ...
    return n(e, [{
      ...
      value: function () {
        ...
        var n = function (e, t) {
          ...
          a = function (e, t) {
            var n = t.deserialize;
            return e.length && (e = f(_(e, n, this)), e = [].concat(e)
              .filter(p)), !!e.length && e;
          }.bind(this),
          r = function (e, t) {
            var n = t.deserialize;
        ...
        ['serialize', 'deserialize', 'onInit', 'onChange', 'onRender', 'setValue', 'getValue'].forEach(function (t) {
          ...
          for (var i in e.dataset) {
            var a = e.dataset[i];
            /true|false/.test(a.toLowerCase()) ? a = 'true' == a.toLowerCase() : '[' == a[0] && ']' == a.substr(-1) ? a = _(a.substr(1, a.length - 2)
              .split(','), t) : /^\d*$/.test(a) && (a = parseInt(a, 10)), n[i] = a;
          }
          return n;
        }(this._el), t));
      }
      ...
      value: function (e) {
        ...
        f && (i && this._dragStart ? this._onmousemove(e) : (this._deselect = !i && this.hasDate(new Date(f)), this._highlighted = [f], this._dragStart = f, r || a('[data-day].' + u, this.wrapper)
          .forEach(function (e) {
            l(e, u);
          }), a('[data-day="' + f + '"]', this.wrapper)
          .forEach(function (e) {
      ...
      value: function (e) {
        ...
        if ((i || r) && 1 === e.buttons) {
          var p = s(e.target, '[data-day]', this.wrapper),
            f = p ? parseInt(p.dataset.day, 10) : null;
          f && this._dragStart && (this._highlighted = g(this._dragStart, f)
            .map(function (e) {
              return e.getTime();
            }), this._isDragging = f !== this._dragStart, a('[data-day].' + c, this.wrapper)
            .forEach(function (e) {
              var n = new Date(parseInt(e.dataset.day, 10));
              h(e, u, !i && t.hasDate(n)), l(e, c);
            }), this._highlighted.forEach(function (e) {
            a('[data-day="' + e + '"]', t.wrapper)
              .forEach(function (e) {
                h(e, u, !t._deselect), o(e, c);
              });
          }));
      ...
      value: function (e) {
        ...
        n.hasAttribute('data-prev') ? this.prev(n.dataset.prev) : n.hasAttribute('data-next') ? this.next(n.dataset.next) : n.hasAttribute('data-year') && !n.onchange ? n.onchange = function () {
          ...
          var e = n.dataset.period,
            i = 'am' === n.value ? -12 : 12;
          a('[data-hour="' + e + '"] option', t.wrapper)
            .forEach(function (e) {
      ...
      value: function (e, t) {
        ...
        }), a ? o = (o = o.concat(this.getDate())
          .sort(c)).length ? g(o[0], o.pop()) : [] : r || (o = o.slice(0, 1)), o.map(function (e) {
          return f(e)
            .getTime();
        })
          .forEach(function (e) {
        ...
        if (a) {
          ...
          return ('ranged' === a || i) && (o = r.time['start' === e ? 1 : 2]), this._renderers.timepicker({
            ...
            renderMinuteSelect: function () {
              for (var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 15, i = [], a = 0; a < 60; a += n) {
                i.push({
                  text: a < 10 ? '0' + a : a,
                  selected: s[1] === a,
                  disabled: !1,
